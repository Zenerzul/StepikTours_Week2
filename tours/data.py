...
description = ("Лучшие направления, где никто не будет мешать Вам сидеть на берегу и изучать 
...
tours = {
    1: {
        ...
        "description": ("Отель выглядит уютно. Он был построен из красного соснового дерева 
                        и украшен синими камнями.  Высокие округлые окна добавляют общий стиль дома и были 
