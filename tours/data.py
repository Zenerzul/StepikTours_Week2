...
description = "Лучшие направления, где никто не будет мешать Вам сидеть на берегу и изучать программирование, дизайн, разработку игр и управление продуктами"
